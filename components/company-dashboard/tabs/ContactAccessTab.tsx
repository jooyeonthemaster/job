  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">연락처 열람 요청</h2>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="text-sm mt-1">대기 중</div>
        </button>
        <button
        ...
        >
          ...
          <div className="text-sm mt-1">승인됨</div>
        </button>
        <button
        ...
        >
          ...
          <div className="text-sm mt-1">거절됨</div>
        </button>
      </div>
        ...
        <div className="grid gap-4">
          {requests.map((request) => {
            ...
            return (
              <div
                key={request.id}
                className={`bg-white rounded-md p-6 shadow-sm border transition-all ${
                  isApproved
