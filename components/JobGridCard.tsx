      ...
      <Link href={`/jobs/${job.id}`} className="block">
        ...
        >
          ...
          <div className={cn(
            ...
            job.logo ? 'bg-white' : 'bg-gradient-to-br from-primary-500 to-primary-600 text-white'
          )}>
            {job.logo ? (
              <Image
                src={job.logo}
                alt={job.company}
                width={size === 'small' ? 80 : size === 'medium' ? 96 : 112} // 2x 해상도 (Retina 디스플레이 대응)
                height={size === 'small' ? 80 : size === 'medium' ? 96 : 112} // 2x 해상도 (Retina 디스플레이 대응)
