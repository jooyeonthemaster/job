...
import { validateEmail, validatePassword } from '@/types/jobseeker-onboarding.types';
...
export default function AccountSection({ formData, errors, isEmailSignup, onChange }: AccountSectionProps) {
