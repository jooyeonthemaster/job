        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900">기업 회원 로그인</h2>
              <p className="text-gray-600 mt-2">인재를 찾고 계신 기업 전용</p>
            </div>
            {/* Error Message */}
            {error && (
          ...
          <div className="text-center mt-8 space-y-2">
            ...
            <p className="text-gray-600">
              개인 회원이신가요?{' '}
              <Link href="/login/jobseeker" className="text-primary-600 hover:text-primary-700 font-medium">
                개인 회원 로그인
              </Link>
            </p>
          </div>
